...
app = FastAPI(
    ...
    title="Interfejs API Fantasy Football Sports World Central (SWC)",
    version="0.2",
    servers=[
        {"url": "https://sturdy-space-parakeet-v6gw9xp59qqc7rq-8000.app.github.dev",         
        "description": "Serwer główny"}
    ]
)
...
@app.get(
    ...
    description="""Użyj tego punktu końcowego, aby uzyskać listy lig futbolu fantasy SWC. Parametry skip i limit służą do obsługi stronicowania. Nazwa ligi nie jest unikatowa. Nie używaj identyfikatora ligi do zliczania lub analityki, ponieważ nie ma gwarancji, że będzie on sekwencyjny.""",
...
@app.get(
    ...
    description="""Użyj tego punktu końcowego, aby uzyskać listy drużyn SWC fantasy football. Opcje skip i limit służą do stronicowanie wyników. Nazwa drużyny nie musi być unikatowa. Możesz dopasować id drużyny z innego zapytania. Nie używaj id drużyny do zliczania lub innych obliczeń.""",
